...
export default class onBoard extends Component {
  ...
  async componentDidMount() {
    ...
    // setTimeout(() => this.props.navigation.navigate('onBoard_3'), 2000);
  }
  render() {
    return (
      <View style={styles.container}>
        <View style={styles.heading}>
          <View>
            <Image
              source={require('../../img/onBoard_3.png')}
              style={styles.image}
            />
          </View>
          <View style={styles.CONTAINERS_onboard}>
            <View>
              <Text style={styles.home_text}>Everything in your hands</Text>
            </View>
            <View>
              <Text style={styles.info_text}>
                With Nigga Barber, find high-quality barbershops, see reviews,
                and make appointments easily. Achieve your confident appearance!
              </Text>
            </View>
            <TouchableOpacity
