    ...
    return (
      <View style={styles.container}>
        <View style={styles.heading}>
          <View>
            <Image
              source={require('../../img/onBoard_2.png')}
              style={styles.image}
            />
          </View>
          <View style={styles.CONTAINERS_onboard}>
            <View>
              <Text style={styles.home_text}>Loooking for Nigga Barber?</Text>
            </View>
            <View>
              <Text style={styles.info_text}>
                Find the best barbershop around you in seconds, make an
                appointment, and enjoy the best grooming experience.
              </Text>
            </View>
            <TouchableOpacity
